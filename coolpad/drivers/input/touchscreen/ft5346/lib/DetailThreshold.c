...
void OnGetTestItemParam(char *strItemName, char *strIniFile, int iDefautValue)
{
	...
	sprintf(strValue, "%d", iDefautValue);
	GetPrivateProfileString( "Basic_Threshold", strItemName, strValue, str, strIniFile); 
	iValue = atoi(str);
	dividerPos = GetPrivateProfileString( "SpecialSet", strItemName, "", str, strIniFile); 
