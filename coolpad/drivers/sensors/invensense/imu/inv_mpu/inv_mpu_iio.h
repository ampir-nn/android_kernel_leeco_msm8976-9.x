...
/*#define CONFIG_INV_I2C_TIMEOUT_WAIT //yulong add for I2C Timeout wait*/
/**
...
#ifdef CONFIG_YL_ACCEL_CALIBRATION
struct acc_offset {
	signed short  key; /*0:without calibration 1:success 2:fail*/
...
#define MPU6881_ID               0x78      /* unique WHOAMI */
