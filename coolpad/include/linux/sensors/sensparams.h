...
extern ssize_t sensparams_write_to_flash(int type, unsigned char *in, int len);
extern int sensparams_read_from_flash(int type, unsigned char *out, int len);
