...
#define PA12200001_INPUT_NAME	 ALSPROX_INPUT_NAME
...
struct pa12200001_platform_data {
	...
	unsigned char		pa12_ps_offset_default;/*for x-talk canceling 5 */
	...
	unsigned char		pa12_int_set;/*0:ALS interrupt,1:PS interrupt,3 BOTH interrupt 1 */
	unsigned char           pa12_int_type;
	unsigned char		pa12_ps_mode;/*0:OFFSET MEASURE;3:NORMAL 3 */
	unsigned char		pa12_ps_period;/*2:25ms,3:50ms sleep time 1 */
	unsigned char		pa12_als_period;/*0ms 0 */
};
